...
parser.add_argument('-o', dest="outDir", help="Export directory for the concatenated fastq files. (use full path)", required=True, default='/media/christos/ssd/work/Infants/publication/sequence_data')
