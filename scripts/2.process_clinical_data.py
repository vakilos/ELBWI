...
## I.E == international unit == g??,
##Nystatin in ml?? What is the concentration,
#mg,
#'Appl is a messs, some antibiotics are applied on the eyes, '
#gtt --> get dose from the additional column (drops)
