...
parser=argparse.ArgumentParser(description="Blasts reads from negative controls against NCBI's 16S rRNA database. Run in an python environment with the latest version of blast+ installed")
